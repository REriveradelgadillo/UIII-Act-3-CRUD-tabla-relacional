...
$sentenciaProductos = $base_de_datos->prepare("SELECT p.nombre_p, p.marca,p.codigo,p.color,p.categoria,p.precio,p.precio_proveedor,p.tamano,     pv.cantidad
FROM productos p
INNER JOIN 
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th class="producto">PRODUCTO Y PRECIO</th>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="producto"><?php echo $producto->nombre_p;  ?> <strong>$<?php echo number_format($producto->precio, 2) ?></strong></td>
